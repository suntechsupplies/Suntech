...
User Function fMATR730()

	Local oReport
	Local aPDFields	:= {"A1_NOME","A1_END","A1_ENDENT","A1_CGC","A1_INSCR","A3_NOME","A1_CEPE","A1_CEP","A2_NOME","A2_CGC","A2_END"}
...
@description    Inicializa variaveis com lista de campos que devem ser ofuscados de acordo com usuario.
