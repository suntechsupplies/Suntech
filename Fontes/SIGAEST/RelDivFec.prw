...
Static Function ProcRel()
	...
	TRCell():new(oSectCab, "LOTE", 		cAlias, "Lote", 		PesqPict("SB1","B1_RASTRO", ), 	TAMSX3("B1_RASTRO")[1],	/*lPixel*/,/*{|| code-block de impressao }*/)
	TRCell():new(oSectCab, "ENDERECO", 	cAlias, "Endereço",		PesqPict("SB1","B1_LOCALIZ", ),	TAMSX3("B1_LOCALIZ")[1],/*lPixel*/,/*{|| code-block de impressao }*/)
	...
	TRCell():new(oSectCab, "CUSFIM", 	cAlias, "Custo Medio", 	PesqPict("SB2","B2_CM1", ), 	TAMSX3("B2_CM1")[1],	/*lPixel*/,/*{|| code-block de impressao }*/)         
