...
user function EJTABIT()

return

WSRESTFUL EJTabitens DESCRIPTION Desc_Rest

	WSDATA 	nPag 	As Integer
	WSMETHOD GET DESCRIPTION Desc_Get WSSYNTAX "/EJTabitens || /EJTabitens/{}"

END WSRESTFUL


WSMETHOD GET WSRECEIVE nPag WSSERVICE EJTabitens
	Local aArea		:= GetArea()
